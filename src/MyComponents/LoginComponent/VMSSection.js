    ...
    <div className="vms-section">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path
          ...
          d="M0,160L48,165.3C96,171,192,181,288,160C384,139,480,85,576,85.3C672,85,768,139,864,160C960,181,1056,171,1152,170.7C1248,171,1344,181,1392,186.7L1440,192L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"
        ></path>
      </svg>
      ...
      <div className="vms-content">
        <h2>VMS</h2>
        <p>
          Vendor Management System helps you track vendors, products, and sales
          efficiently with modern analytics and control.
        </p>

        <div className="vms-advantages">
          ...
          <div className="adv-card">
          <img
            src='data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" height="40" width="40" viewBox="0 -960 960 960" fill="white"><path d="M318.67-418v-298.67h100V-418l-50-48.67-50 48.67Zm196 80.67V-880h100v442.67l-100 100Zm-392 112.66v-328h100v228l-100 100ZM120-118l250-250 146.67 128.67L766-488.67h-80v-66.66h194V-362h-66.67v-80l-294 294-146.66-128-158 158H120Z"/></svg>'
            alt="Analytics"
          />

...
const columns = [
  ...
  { header: "Invoice Date", field: "invoiceDate", width: "140px" },
  { header: "Total (₹)", field: "", width: "130px" },
  { header: "Tax (₹)", field: "totalTax", width: "120px" },
  { header: "Discount (₹)", field: "totalDiscount", width: "130px" },
  { header: "Net Amount (₹)", field: "netAmount", width: "140px" },
  { header: "Paid (₹)", field: "amountPaid", width: "130px" },

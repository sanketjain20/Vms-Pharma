      ...
      {open && (
        <aside className="vmsa-panel" aria-label="VMS Assistant">
          <div className="vmsa-header">
            ...
            <div>
              <div className="vmsa-title">VMS Assistant</div>

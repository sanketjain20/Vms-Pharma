  ...
  return (
    <div className="rlv-cpf">
      <div className="rlv-cpf-top">
        <span className="rlv-cpf-heading">Collect Payment</span>
...
export default function RetailerLedgerView({ uKey, onClose }) {
  ...
  const fetchLedger = async () => {
    ...
    try {
      const res  = await fetch(
        `http://localhost:8080/api/RetailerLedger/Ledger/${uKey}`,
                        ...
                        <div key={idx}>
                          <div
                            className={[
                              ...
                              collectingId === inv.salesId   ? "rlv-inv-collecting": "",
                            ].filter(Boolean).join(" ")}
                    ...
                    <>
                      ...
                      <div className="rlv-history-summary">
                        <div className="rlv-hs-block">
                          <span className="rlv-hs-label">Total Collected</span>
                        ...
                        <div className="rlv-hs-block">
                          <span className="rlv-hs-label">Last Received</span>
                          <span className="rlv-hs-val">
                            {ledger.paymentHistory[0]?.collectedAt || "—"}
                          </span>
                        </div>
                      </div>
                          ...
                          <tbody>
                            {ledger.paymentHistory.map((ph, idx) => (
                              ...
                              >
                                ...
                                <td className="rlv-td-dim">{ph.collectedAt || "—"}</td>
                                <td>
                                ...
                                <td className="rlv-td-dim">
                                  {ph.note || <span className="rlv-empty">—</span>}
                                </td>
                                <td className="rlv-td-amount">
                                  ₹{fmt(ph.amountCollected)}
                                </td>
                              </tr>
                            ))}
                          </tbody>

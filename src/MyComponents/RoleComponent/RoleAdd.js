        ...
        {initialLoading ? (
          ...
          <>
            <div className="afx-header">
              <div>
                <div className="afx-eyebrow"><span className="afx-eyebrow-dot" />New Role</div>
                <h3 className="afx-title">Add Role</h3>
              </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="afx-footer">
                ...
                <button type="submit" className="afx-btn afx-btn--primary">Save Role</button>
              </div>
            </form>
          </>
        )}
